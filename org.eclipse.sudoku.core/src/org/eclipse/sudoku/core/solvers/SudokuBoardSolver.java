 ...
 *******************************************************************************/
package org.eclipse.sudoku.core.solvers;
...
public interface SudokuBoardSolver {
	void solve(SudokuBoard board, IProgressMonitor monitor) throws CannotSolveSudokuBoardException;
}
