 ...
 */
public class SudokuUiActivator extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.sudoku.ui";

	// The shared instance
	private static SudokuUiActivator plugin;
	
	/**
	 * The constructor
	 */
	public SudokuUiActivator() {
		plugin = this;
	}
	 ...
	 */
	public static SudokuUiActivator getDefault() {
		return plugin;
	}
